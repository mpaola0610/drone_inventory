...
def create_drone(current_user_token):
    ...
    drone = Drone(name,description,price,camera_quality,flight_time, max_speed, dimensions, weight, cost_of_product, series, user_token)
...
def update_drone(current_user_token, id):
    ...
    drone.cost_of_product = request.json['cost_of_product']
